...
//删除Unit缓存
	...
	[ResponseType(nameof(G2M_ChangeRoomState))]
	[Message(InnerOpcode.M2G_ChangeRoomState)]
	[ProtoContract]
	public partial class M2G_ChangeRoomState: Object, IActorRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[Message(InnerOpcode.G2M_ChangeRoomState)]
	[ProtoContract]
	public partial class G2M_ChangeRoomState: Object, IActorResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
